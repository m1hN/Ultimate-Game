...
function drawDragon() {
  ...
  ctx.moveTo(50, 0);
  ctx.lineTo(102, 92);
  ctx.lineTo(155.5, 152);
  ctx.lineTo(272.5, 181);
  ctx.lineTo(275.5, 253);
  ctx.lineTo(350, 300);
  ctx.lineTo(424.5, 253);
  ctx.lineTo(427.5, 181);
  ctx.lineTo(554.5, 142);
  ctx.lineTo(598, 92);
  ctx.lineTo(650, 0);
  ctx.fill();
  ctx.beginPath();
  ...
  ctx.fill();
  ctx.beginPath();
  ctx.arc(195.5, 68, 10, 0, 2 * Math.PI);
  ctx.fill();
  ctx.fillStyle = "hotpink";
  ctx.beginPath();
  ctx.moveTo(86.5 + 20, 11 + 10);
  ctx.lineTo(190.5 + 20, 11 + 10);
  ctx.lineTo(224.5 + 20, 40 + 10);
  ctx.lineTo(237.5 + 20, 129 + 10);
  ctx.lineTo(136.5 + 20, 79 + 10);
  ctx.lineTo(86.5 + 20, 11 + 10);
  ctx.fill();
  ctx.beginPath();
  ctx.moveTo(594.5, 11 + 10);
  ctx.lineTo(490.5, 11 + 10);
  ctx.lineTo(456.5, 40 + 10);
  ctx.lineTo(443.5, 129 + 10);
  ctx.lineTo(544.5, 79 + 10);
  ctx.lineTo(594.5, 11 + 10);
  ctx.fill();
  ctx.fillStyle = "turquoise";
  ctx.beginPath();
  ctx.arc(350, 123, 5, 0, 2 * Math.PI);
  ctx.fill();
  ctx.beginPath();
  ctx.arc(330, 33, 5, 0, 2 * Math.PI);
  ctx.fill();
  ctx.beginPath();
  ctx.arc(370, 33, 5, 0, 2 * Math.PI);
  ctx.fill();
  ctx.beginPath();
  ctx.arc(315.5, 235, 5, 0, 2 * Math.PI);
  ctx.fill();
  ctx.beginPath();
  ctx.arc(384.5, 235, 5, 0, 2 * Math.PI);
  ctx.fill();
  ctx.strokeStyle = "teal";
  ctx.beginPath();
  ctx.moveTo(289.5, 189);
  ctx.lineTo(350, 169);
  ctx.lineTo(411.5, 189);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(350, 174);
  ctx.lineTo(350, 250);
  ...
  ctx.moveTo(101.5, 23);
  ctx.lineTo(153.5, 94);
  ctx.lineTo(256.5, 142);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(598.5, 23);
  ctx.lineTo(547.5, 94);
  ctx.lineTo(443.5, 142);
  ctx.stroke();
  ...
  ctx.fillStyle = "white";
  ctx.beginPath();
  ctx.moveTo(190.5 + 20, 11 + 10);
  ctx.lineTo(200.5 + 20, 20 + 10);
  ctx.lineTo(182.5 + 20, 102 + 10);
  ctx.lineTo(136.5 + 20, 79 + 10);
  ctx.lineTo(190.5 + 20, 11 + 10);
  ctx.fill();
  ctx.beginPath();
  ctx.moveTo(510.5 - 20, 11 + 10);
  ctx.lineTo(500.5 - 20, 20 + 10);
  ctx.lineTo(518.5 - 20, 102 + 10);
  ctx.lineTo(564.5 - 20, 79 + 10);
  ctx.lineTo(510.5 - 20, 11 + 10);
  ctx.fill();
  ctx.beginPath();
  ctx.moveTo(273, 191);
  ctx.lineTo(259, 212);
  ...
  ctx.fill();
  ctx.beginPath();
  ctx.moveTo(294.5, 264);
  ctx.lineTo(291.5, 279);
  ctx.lineTo(323.5, 312);
  ctx.lineTo(313.5, 288);
  ctx.lineTo(316.5, 278);
  ctx.moveTo(294.5, 264);
  ctx.fill();
  ctx.beginPath();
  ctx.moveTo(405.5, 264);
  ctx.lineTo(408.5, 279);
  ctx.lineTo(376.5, 312);
  ctx.lineTo(386.5, 288);
  ctx.lineTo(383.5, 278);
  ctx.moveTo(405.5, 264);
  ctx.fill();
  ctx.fillStyle = "#00072D";
  ctx.beginPath();
  ...
  ctx.fillStyle = "#00072D";
  ctx.beginPath();
  ctx.arc(504.5, 68, 10, 0, 2 * Math.PI);
  ctx.fill();
}
